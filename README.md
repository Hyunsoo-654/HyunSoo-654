...
|:---|:---|:---|:---|
| **VGA PK Game Project** <br> 📅(25.08.16 ~ 25.09.30) | - **SCCB** 기반 카메라 제어와 **VGA** 출력으로 실시간 영상 처리 구현<br> - PC ↔ FPGA 간 **UART 통신**을 통한 양방향 축구 게임 구현<br> -**Sobel·Color·Chroma key 필터**를 활용한 좌표 추적, Grid 선택, 인터랙티브 <br>환경 구축<br> -**MicroBlaze CPU**와 **AXI4-Lite** 구조를 통한 메모리·주변장치 제어 | 대한상공회의소 | [Ronaldo_PK Project](https://github.com/71105673/Ronaldo_Project) |
