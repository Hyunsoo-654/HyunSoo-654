...
|:---|:---|:---|:---|
| **VGA PK Game Project** <br> 📅(25.08.16 ~ 25.09.30) | - **???** | 대한상공회의소 | [Ronaldo_PK Project](https://github.com/71105673/Ronaldo_Project) |
...
| **스마트 홈 케어 시스템** <br> 📅(25.07.01 ~ 25.07.10) | - **라즈베리파이 기반의 스마트 홈케어 IoT 시스템 구축**을 목표로<br> **MobileNetV2-Keras CNN**을 활용한 손동작 및 사람 인식 기술과<br> **LLM(Gemma3 1B) 기반**의 자연어 처리 기능을 통합<br> 두 가지 직관적인 입력 방식을 모두 사용하여 **LED 및 모터**와 같은 기기를 실시간으로 제어| 대한상공회의소 | [스마트 홈 케어 시스템](https://github.com/chanwon3144/AI-PROJECT) |
