...
- 디지털·아날로그 회로부터 SoC와 HW 설계까지 폭넓은 경험을 바탕으로, 시스템에 대한 넓은 Insight를 갖춘 엔지니어입니다. 
- 긍정적인 에너지를 나눠주며 팀과의 원활한 협업을 이끌고, 프로젝트의 완성도를 높입니다.

## 🎓 Education  
| 졸업연월   | 학교명         | 전공             | 구분 | 학점(총 이수)     | 전공학점(총 이수)| 소재지 |
|------------|----------------|------------------|------|----------|----|--------|
| 2025.02.14 | 인하대학교     | 정보통신공학 (계열: 전자-전기)    | 졸업 | 3.82/4.5 (131) | 3.77/4.5 (65) |인천   |
